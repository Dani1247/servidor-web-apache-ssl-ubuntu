...
1. Configuración de adaptadores de red y máquinas virtuales
2. Instalación y configuración inicial de Ubuntu Server 24.04
3. Servidor DNS y DHCP con dnsmasq
4. Instalación y configuración de Apache (Virtual Hosts)
5. Certificados SSL/TLS y HTTPS
6. Firewall con iptables
7. Página web de prueba (HTML + PHP)
